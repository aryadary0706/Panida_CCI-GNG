...
func _ready():
	...
	spawn_timer.wait_time = 0.5 # Jeda antar spawn 1.2 detik
...
func spawn_enemy(enemy_info: Dictionary) -> void:
	...
	if enemy_type == "enemy_basic":
		enemy_scene = preload("res://scenes/route/Entity1_route.tscn")
	elif enemy_type == "enemy_pro":
		enemy_scene = preload("res://scenes/route/Entity2_route.tscn")
