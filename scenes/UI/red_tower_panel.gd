...
func _ready():
	# Set default border
	border_default.border_width_bottom = 0
	border_default.bg_color = Color(0.1, 0.1, 0.1)

	# Set border aktif (misal garis bawah merah)
	border_active.border_width_bottom = 4
	border_active.border_color = Color(1, 0, 0)
	border_active.bg_color = Color(0.1, 0.1, 0.1)
